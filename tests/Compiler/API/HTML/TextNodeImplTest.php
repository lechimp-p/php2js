...
class TextNodeImplTest extends \PHPUnit\Framework\TestCase {
    const LOCATION = __DIR__."/../../../../src/Compiler/API/HTML/TextNodeImpl.php";

    public function test_smoke() {
        require_once(self::LOCATION);

        $impl = new \HTML\TextNodeImpl(null);

        $this->assertInstanceOf(HTML\TextNode::class, $impl);
    }

...
class TestRunner implements Lechimp\PHP2JS\JS\Script {
    ...
    public function buildTests() {
        return [
            ...
            new JS_Tests\CatchTest(),
            new JS_Tests\Array_\EqualityTest(),
            new JS_Tests\Array_\IndexFetchTest(),
            new JS_Tests\Array_\ForeachScopingTest(),
            ...
            new JS_Tests\Class_\ExtendsGivesAccessToProtectedOfOtherObjectsTest(),
            ...
            new JS_Tests\Closure\TypedParameterTest()
        ];
    }
}
